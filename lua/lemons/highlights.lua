...
function M.get_highlights(c, opts)
    ...
    return {
        ...
        ["@keyword.modifier"] = { fg = c.orange, italic = true },
        ["@keyword.type"] = { fg = c.orange, italic = true },
